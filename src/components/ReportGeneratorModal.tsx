    ...
    doc.write(`
      ...
      <html>
        <head>
          ...
          <title>${horoscope.birthDetails.name || 'ஜாதகக் கணிப்பு'} - Horoscope</title>
          ${styles}
          <style>
            ${allExtractedStyles}
          </style>
          ...
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              <h3 className="text-sm font-bold text-amber-200 font-serif">
                {language === 'ta' ? 'ஸ்ரீ மகா ஜாதகம் (Horoscope)' : 'Horoscope (Print & PDF)'}
              </h3>
              <p className="text-[11px] text-slate-400">
                {language === 'ta' ? 'முழுமையான ஜோதிடக் கணிப்பு' : 'Comprehensive Astrological Report'}
              </p>
            </div>
          </div>
            ...
            <div className="report-page-block w-full max-w-4xl bg-white text-slate-900 font-sans p-6 sm:p-8 flex flex-col justify-between rounded-xl shadow-lg border border-slate-200 box-border relative">
              <div className="space-y-3.5">
                ...
                <div className="border-b-2 border-amber-700/60 pb-2 text-center relative">
                  <div className="text-amber-800 text-[11px] font-serif font-bold tracking-wider mb-1">
                    ஸ்ரீ கணபதி துணை • ஸ்ரீ சிவ குடும்பம் திருவடி போற்றி
                  </div>
                  <div className="text-amber-950 font-serif font-bold text-xs sm:text-sm tracking-wide my-1.5 leading-relaxed">
                    ஜனனீ ஜென்ம செளக் யானாம் வர்த்தனீ குலா ஸம்பதாம்! <br />
                    பதவீ பூர்வ புண்யாநாம் லிக்யதே ஜென்ம பத்திரிகா !!
                  </div>
                  <h1 className="text-xl sm:text-2xl font-bold font-serif text-amber-950 tracking-wide mt-1">
                    ஸ்ரீ மகா ஜாதகக் கணிப்பு
                  </h1>
